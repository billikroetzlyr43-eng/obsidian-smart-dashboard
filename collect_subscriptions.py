...
Outputs:
  - <vault>/.smart-dashboard/subscriptions.json (quota data)
  - <vault>/.smart-dashboard/subscriptions_config.json (encrypted credentials)
...
# ------------------------------------------------------------------ config
VAULT_DASHBOARD = r"<vault>/.smart-dashboard"
