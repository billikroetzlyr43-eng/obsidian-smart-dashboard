...
## 🩹 v4.9.6 附：体育卡全卡时间全面核查（数据层修正）

**起因**：修复 A/B 之后用户仍发现诺丁汉森林时间不对，要求核查整个体育卡所有时间。本项为**数据层（sports.json）修正**，不涉及代码（parseDt 上轮已修好）。

**方法**：逐场以权威官方源交叉核对三联赛全部场次北京时间：英超 = premierleague.com 380 场全表（含 Sky/TNT 电视场标注）；F1 = ESPN F1 Schedule（官方 23 站剩余 11 站）；德甲 = fcbayern.com 官方 fixture list + ESPN。用代码统一时区换算（英国/德国 10/25 转冬令时、2027 春转夏令时），逐场 diff「去 `(+1)` 后的值 vs 官方北京」。

### 森林（38 场）→ 6 场错
根因：填充时统一按「默认 15:00 UK × 冬令时」换算，**漏了电视场与日期**：
| 轮 | 对阵 | 原值 | 官方北京（premierleague）|
|---|---|---|---|
| R2 | 利物浦 vs 森林 | 22:00 | **19:30**（官方 12:30 TNT）|
| R5 | 森林 vs 考文垂 | 22:00 | **次日 00:30**（官方 17:30 Sky）|
| R6 | 水晶宫 vs 森林 | 10/10 22:00 | **10/11 周日 21:00**（官方 14:00 Sky，日期也错）|
| R7 | 森林 vs 阿森纳 | 10/17 22:00 | **10/18 周日 23:30**（官方 16:30 Sky，日期也错）|
| R8 | 伊普斯维奇 vs 森林 | 10/24 22:00 | **10/24 03:00(+1)**（官方 10/23 周五 20:00 Sky，日期也错）|
| R38 | 考文垂 vs 森林 | 5/30 23:00 | **5/30 22:00**（2027 春 BST 算错）|

### F1（11 场）→ 1 场错
- R19 墨西哥城 2026-11-02 04:00(+1) → **2026-11-02 03:00**（官方 3pm ET 转北京）；其余 10 场逐场核对一致（意大利/西班牙 21:00 等）。

### 拜仁（14 场）→ 日期窗口全部正确，开球时刻远期未定
- 对手/轮次/日期全部命中官方窗口（如 R2 沙尔克 4-6/9、R8 多特 30/10-1/11）。
- **注意**：除首轮（8/28 20:30CEST → 8/29 02:30 北京）外，德甲其余场次 `fcbayern` 官方明确「exact kick-off times will only be finalised as the season progresses」——**远期场具体开球时间官方未公布**，卡片当前为其常规晚场 20:30CEST 估算值（北京次日 02:30，冬令时后 03:30），note 已标注「以官方公布为准」，非确定值。

### 验收
- sports.json 逐场重载校验，森林 R2/R5/R6/R7/R8/R38、F1 R19 已修正落盘；拜仁日期窗口核对通过。
- 教训：**默认时区换算仅对「无电视标注」场次成立**；凡 Sky/TNT 已公布的电视场、跨日月/周五场、春季夏令时切换，必须逐场核对官方源，不能统一套默认值。
