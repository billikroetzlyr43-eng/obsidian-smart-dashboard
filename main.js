...
__export(main_exports, {
  VIEW_TYPE_SMART_DASHBOARD: () => VIEW_TYPE_SMART_DASHBOARD,
  default: () => SmartDashboardPlugin
});
...
var CreateTradeModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    const { contentEl } = this;
    contentEl.createEl("h2", { text: `\u{1F4B9} \u5FEB\u6377\u5F55\u5165\u4EA4\u6613\u590D\u76D8` });
    let tradeDate = (0, import_obsidian.moment)().format("YYYY-MM-DD");
    let ticker = "";
    let action = "\u4E70\u5165";
    let price = "";
    let volume = "";
    ...
    new import_obsidian.Setting(contentEl).setName("\u4EA4\u6613\u65E5\u671F").addText((text) => {
      text.inputEl.type = "date";
      text.setValue(tradeDate);
      text.onChange((value) => tradeDate = value);
    });
    new import_obsidian.Setting(contentEl).setName("\u4EA4\u6613\u6807\u7684").addText((text) => {
      text.setPlaceholder("\u5982: \u8D35\u5DDE\u8305\u53F0 (600519)");
      text.inputEl.setAttribute("list", datalistId);
      text.onChange((value) => ticker = value);
    });
    new import_obsidian.Setting(contentEl).setName("\u64CD\u4F5C\u7C7B\u578B").addDropdown((drop) => {
      drop.addOption("\u4E70\u5165", "\u4E70\u5165");
      drop.addOption("\u5356\u51FA", "\u5356\u51FA");
      drop.onChange((value) => action = value);
    });
    new import_obsidian.Setting(contentEl).setName("\u6210\u4EA4\u4EF7\u683C").addText((text) => {
      text.inputEl.type = "number";
      text.inputEl.step = "0.01";
      text.setPlaceholder("\u5982: 15.2");
      text.onChange((value) => price = value);
    });
    new import_obsidian.Setting(contentEl).setName("\u6210\u4EA4\u6570\u91CF/\u91D1\u989D").addText((text) => {
      text.inputEl.type = "number";
    ...
    new import_obsidian.Setting(contentEl).addButton(
      (btn) => btn.setButtonText("\u4E00\u952E\u751F\u6210").setCta().onClick(() => {
        if (!ticker) {
          new import_obsidian.Notice("\u8BF7\u8F93\u5165\u4EA4\u6613\u6807\u7684\uFF01");
          return;
        }
        this.close();
...
var EditTradeModal = class extends import_obsidian.Modal {
  constructor(app, plugin, trade, tickers, onSubmit) {
    super(app);
    this.plugin = plugin;
    this.trade = trade;
    this.tickers = tickers;
  ...
  onOpen() {
    ...
    let tradeDate = this.trade.date || (0, import_obsidian.moment)(this.trade.timestamp).format("YYYY-MM-DD");
...
var SmartDashboardPlugin = class extends import_obsidian.Plugin {
  async onload() {
    try {
      this.registerView(
...
var CreatePaperModal = class extends import_obsidian.Modal {
  constructor(app, onSubmitManual) {
    super(app);
  ...
  onOpen() {
    ...
    new import_obsidian.Setting(contentEl).setName("\u901A\u8FC7 Zotero \u5BFC\u5165").setDesc("\u5524\u8D77 Zotero \u63D2\u4EF6\u5BFC\u5165\u6587\u732E").addButton((btn) => btn.setButtonText("\u5BFC\u5165").setCta().onClick(() => {
      this.close();
      try {
        const commands = this.app.commands.listCommands();
        const targetCommand = commands.find((c) => c.id.includes("obsidian-zotero-desktop-connector") && c.id.toLowerCase().includes("dashboardimport"));
        if (targetCommand) {
          this.app.commands.executeCommandById(targetCommand.id);
          new import_obsidian.Notice("\u5DF2\u5524\u8D77 Zotero DashboardImport \u6A21\u677F");
        } else {
          this.app.commands.executeCommandById("obsidian-zotero-desktop-connector:zdc-import-notes");
          new import_obsidian.Notice("\u5DF2\u5C1D\u8BD5\u5524\u8D77 Zotero \u9ED8\u8BA4\u5BFC\u5165\u547D\u4EE4");
        }
      } catch (e) {
        new import_obsidian.Notice("\u65E0\u6CD5\u8C03\u7528 Zotero \u63D2\u4EF6\u547D\u4EE4");
      }
    }));
    let subject = "";
    new import_obsidian.Setting(contentEl).setName("\u624B\u52A8\u521B\u5EFA").setDesc("\u8F93\u5165\u8BBA\u6587\u540D\u79F0\uFF0C\u751F\u6210\u6807\u51C6\u6A21\u677F").addText((text) => text.onChange((value) => subject = value)).addButton((btn) => btn.setButtonText("\u521B\u5EFA").onClick(() => {
      if (!subject) {
        new import_obsidian.Notice("\u8BF7\u8F93\u5165\u8BBA\u6587\u540D\u79F0");
        return;
      }
      this.close();
...
var CreateOtherModal = class extends import_obsidian.Modal {
  constructor(app, plugin, onCreateNormal) {
    super(app);
    this.plugin = plugin;
  ...
  onOpen() {
    ...
    new import_obsidian.Setting(contentEl).setName("\u5BFC\u5165\u5C0F\u7EA2\u4E66\u7B14\u8BB0").setDesc("\u5524\u8D77 Xiaohongshu Importer Plus \u63D2\u4EF6").addButton((btn) => btn.setButtonText("\u5BFC\u5165").setCta().onClick(() => {
      this.close();
      try {
        this.app.commands.executeCommandById("xhs-importer:import");
        new import_obsidian.Notice("\u5DF2\u5524\u8D77\u5C0F\u7EA2\u4E66\u5BFC\u5165\u5668");
      } catch (e) {
        new import_obsidian.Notice("\u65E0\u6CD5\u8C03\u7528\u5C0F\u7EA2\u4E66\u5BFC\u5165\u63D2\u4EF6\uFF0C\u8BF7\u786E\u4FDD\u5DF2\u5B89\u88C5\u5E76\u542F\u7528");
      }
    }));
    new import_obsidian.Setting(contentEl).setName("\u4ECE\u5FAE\u4FE1\u516C\u4F17\u53F7\u5BFC\u5165").setDesc("\u5524\u8D77\u5FAE\u4FE1\u516C\u4F17\u53F7\u6293\u53D6\u63D2\u4EF6").addButton((btn) => btn.setButtonText("\u5BFC\u5165").setCta().onClick(() => {
      this.close();
      try {
        this.app.commands.executeCommandById("obsidian-wechat-fetcher:fetch-wechat-article");
      } catch (e) {
        new import_obsidian.Notice("\u65E0\u6CD5\u8C03\u7528\u5FAE\u4FE1\u5BFC\u5165\u63D2\u4EF6\uFF0C\u8BF7\u786E\u4FDD\u5DF2\u5B89\u88C5\u5E76\u542F\u7528");
      }
    }));
    new import_obsidian.Setting(contentEl).setName("\u65B0\u5EFA\u666E\u901A\u7A7A\u767D\u7B14\u8BB0").addButton((btn) => btn.setButtonText("\u65B0\u5EFA").onClick(() => {
      this.close();
      this.onCreateNormal();
    }));
  }
...
var CreateNoteModal = class extends import_obsidian.Modal {
  constructor(app, type, options, onSubmit) {
    super(app);
    this.type = type;
    this.options = options;
    this.onSubmit = onSubmit;
  ...
  onOpen() {
    ...
    if (this.options.length > 0) {
      new import_obsidian.Setting(contentEl).setName(`\u9009\u62E9\u5DF2\u6709${label}`).addDropdown((drop) => {
        this.options.forEach((opt) => drop.addOption(opt, opt));
        drop.onChange((value) => subject = value);
      });
    }
    new import_obsidian.Setting(contentEl).setName(`\u6216\u8005\u8F93\u5165\u65B0\u7684${label}`).addText((text) => text.onChange((value) => subject = value));
    new import_obsidian.Setting(contentEl).addButton((btn) => btn.setButtonText("\u521B\u5EFA").setCta().onClick(() => {
      this.close();
...
var ManageTodoModal = class extends import_obsidian.Modal {
  constructor(app, plugin, todo, onSave) {
    super(app);
    this.plugin = plugin;
    this.todo = todo;
    this.onSave = onSave;
  ...
  onOpen() {
    ...
    let hasTime = !!(((_b = this.todo) == null ? void 0 : _b.date) || ((_c = this.todo) == null ? void 0 : _c.time));
    let date = ((_d = this.todo) == null ? void 0 : _d.date) || (0, import_obsidian.moment)().format("YYYY-MM-DD");
    let time = ((_e = this.todo) == null ? void 0 : _e.time) || "";
    ...
    new import_obsidian.Setting(contentEl).setName("\u622A\u6B62\u65E5\u671F (Deadline)").addText((t) => {
      t.inputEl.type = "date";
    ...
    renderSubtasks();
    new import_obsidian.Setting(contentEl).addButton((btn) => btn.setButtonText("+ \u6DFB\u52A0\u5B50\u4EFB\u52A1").onClick(() => {
      subtasks.push({ id: Date.now().toString(), text: "", completed: false });
      renderSubtasks();
    }));
    let syncSetting = null;
    if (!this.todo) {
      syncSetting = new import_obsidian.Setting(contentEl).setName("\u540C\u65F6\u6DFB\u52A0\u5230\u65E5\u7A0B").setDesc("\u52FE\u9009\u540E\u81EA\u52A8\u5728\u65E5\u7A0B\u5217\u8868\u4E2D\u521B\u5EFA");
...
var ManageScheduleModal = class extends import_obsidian.Modal {
  constructor(app, plugin, schedule, onSave) {
    super(app);
    this.plugin = plugin;
  ...
  onOpen() {
    ...
    let endDate = ((_a = this.schedule) == null ? void 0 : _a.endDate) || date;
    let time = ((_b = this.schedule) == null ? void 0 : _b.time) || "";
    let hasEndTime = !!((_c = this.schedule) == null ? void 0 : _c.endTime);
    let endTime = ((_d = this.schedule) == null ? void 0 : _d.endTime) || "";
    ...
    new import_obsidian.Setting(contentEl).setName("\u7ED3\u675F\u65E5\u671F").addText((text) => {
      text.inputEl.type = "date";
      text.setValue(endDate).onChange((v) => endDate = v);
    });
    new import_obsidian.Setting(contentEl).setName("\u5F00\u59CB\u65F6\u95F4").addText((text) => {
      text.inputEl.type = "time";
      text.setValue(time).onChange((v) => time = v);
    });
    const hasEndSetting = new import_obsidian.Setting(contentEl).setName("\u6709\u7ED3\u675F\u65F6\u95F4\uFF1F");
    const endSetting = new import_obsidian.Setting(contentEl).setName("\u7ED3\u675F\u65F6\u95F4");
    ...
    new import_obsidian.Setting(contentEl).setName("\u6807\u9898").addText((text) => text.setValue(title).onChange((v) => title = v));
    new import_obsidian.Setting(contentEl).setName("\u8BE6\u60C5").addTextArea((text) => text.setValue(contentStr).onChange((v) => contentStr = v));
    if (!this.schedule) {
      new import_obsidian.Setting(contentEl).setName("\u540C\u65F6\u6DFB\u52A0\u5230\u5F85\u529E").setDesc("\u52FE\u9009\u540E\u81EA\u52A8\u5728\u5F85\u529E\u5217\u8868\u4E2D\u521B\u5EFA").addToggle((toggle) => toggle.setValue(syncTodo).onChange((v) => syncTodo = v));
    }
    const btns = new import_obsidian.Setting(contentEl);
    btns.addButton((btn) => btn.setButtonText("\u4FDD\u5B58").setCta().onClick(async () => {
      var _a2;
...
var LogMoodModal = class extends import_obsidian.Modal {
  ...
  async onOpen() {
    ...
    let emoji = (existing == null ? void 0 : existing.emoji) || "\u{1F600}";
    let text = (existing == null ? void 0 : existing.text) || "\u5F00\u5FC3";
    const PRESETS = [
      {
        group: "\u{1F31F} \u5E38\u7528\u72B6\u6001",
        items: [
    ...
    const settingItem = new import_obsidian.Setting(contentEl).setName("\u9009\u62E9\u9884\u8BBE\u72B6\u6001").setDesc("\u5148\u9009\u62E9\u7C7B\u522B\uFF0C\u518D\u9009\u62E9\u5177\u4F53\u72B6\u6001");
    let emojiDropdown;
    ...
    const textInputWrapper = new import_obsidian.Setting(contentEl).setName("\u81EA\u5B9A\u4E49\u6587\u672C");
    let textInput = null;
...
var DayDetailModal = class _DayDetailModal extends import_obsidian.Modal {
  constructor(app, plugin, date, onSave) {
    super(app);
    this.plugin = plugin;
    this.date = date;
  ...
  async onOpen() {
    ...
    let dayNotes = files.filter((f) => {
      ...
      let created = ((_a2 = cache == null ? void 0 : cache.frontmatter) == null ? void 0 : _a2.created) ? (0, import_obsidian.moment)(cache.frontmatter.created) : (0, import_obsidian.moment)(f.stat.ctime);
    ...
    new import_obsidian.Setting(contentEl).addButton((b) => b.setButtonText("\u8BBE\u7F6E/\u4FEE\u6539\u5F53\u65E5\u72B6\u6001").onClick(() => {
      this.close();
    ...
    addSchedBtn.onclick = () => {
      ...
      new ManageScheduleModal(this.app, this.plugin, { id: "", date: this.date, time: "", title: "", content: "" }, () => {
        new _DayDetailModal(this.app, this.plugin, this.date, this.onSave).open();
      }).open();
    };
    if (daySchedules.length) {
      ...
      contentEl.createEl("div", { text: "\u65E0\u65E5\u7A0B", attr: { style: "color: gray; margin-bottom: 15px;" } });
    }
    ...
    if (dayTodos.length) {
      ...
      contentEl.createEl("div", { text: "\u65E0\u5F85\u529E", attr: { style: "color: gray; margin-bottom: 15px;" } });
    }
    let totalWords = 0;
    ...
    if (dayNotes.length) {
      ...
      dayNotes.forEach((s) => {
        ...
        a.onclick = () => {
          this.close();
          this.app.workspace.getLeaf(false).openFile(s);
        };
      });
    } else {
      contentEl.createEl("div", { text: "\u65E0\u7B14\u8BB0", attr: { style: "color: gray" } });
    }
  }
  onClose() {
    this.contentEl.empty();
...
var _SmartDashboardView = class _SmartDashboardView extends import_obsidian.ItemView {
  constructor(leaf, plugin) {
    super(leaf);
    this.lineChart = null;
    this.pieChart = null;
    this.currentMonth = (0, import_obsidian.moment)().startOf("month");
    this.currentMode = "7days";
  ...
  getViewType() {
    return VIEW_TYPE_SMART_DASHBOARD;
  }
  getDisplayText() {
    return `Smart Dashboard ${this.plugin.manifest.version}`;
  }
  getIcon() {
  ...
  async getTheme() {
    ...
    try {
      return JSON.parse(await this.app.vault.adapter.read(path)).theme || "light";
    } catch (e) {
      return "light";
    }
  }
  ...
  async onOpen() {
    ...
    const themeBtn = titleContainer.createEl("button", { text: savedTheme === "dark" ? "\u{1F31E} \u4EAE\u8272" : "\u{1F319} \u6DF1\u8272", cls: "sd-btn secondary" });
    themeBtn.onclick = async () => {
      ...
      themeBtn.innerText = newTheme === "dark" ? "\u{1F31E} \u4EAE\u8272" : "\u{1F319} \u6DF1\u8272";
    ...
    if (inboxFiles.length > 0) {
      ...
      for (let f of inboxFiles) {
        if (f.stat.ctime < oldestTime) {
          oldestTime = f.stat.ctime;
          oldestFile = f;
        }
      }
    ...
    this.registerInterval(window.setInterval(() => {
      ...
      if (el) {
        const body = el.querySelector(".sd-usage-body");
        if (body) {
          body.empty();
  ...
  createCardBody(card) {
    var _a, _b;
    const pos = this.layoutData[card.id];
    const w = (_a = pos == null ? void 0 : pos.w) != null ? _a : 1;
    const h = (_b = pos == null ? void 0 : pos.h) != null ? _b : 1;
    const body = card.createDiv("sd-card-body");
    body.style.width = `${w * _SmartDashboardView.DESIGN_CELL + (w - 1) * _SmartDashboardView.GRID_GAP}px`;
    body.style.height = `${h * _SmartDashboardView.DESIGN_CELL + (h - 1) * _SmartDashboardView.GRID_GAP}px`;
    return body;
  }
  ...
  // ===== 长按拖拽引擎 =====
  getGrid() {
    return this.contentEl.querySelector(".sd-grid");
  }
  getGridMetrics() {
  ...
  getUniqueFrontmatterField(field) {
    const set2 = /* @__PURE__ */ new Set();
    const files = this.app.vault.getMarkdownFiles();
    files.forEach((f) => {
      var _a;
  ...
  renderSearchArea(container) {
    container.createEl("h3", { text: "\u{1F50D} \u5168\u5E93\u667A\u80FD\u68C0\u7D22", cls: "sd-section-title" });
    ...
    searchBtn.onclick = async () => {
      ...
      if (matchedFiles.length === 0) {
        resultsArea.createEl("div", { text: "\u672A\u627E\u5230\u5339\u914D\u7B14\u8BB0\u3002" });
        return;
      }
...
`;
    const file = await this.app.vault.create(filePath, content);
    new import_obsidian.Notice(`\u5DF2\u521B\u5EFA\u7B14\u8BB0: ${title}`);
    this.app.workspace.getLeaf(false).openFile(file);
  }
  async renderCalendarArea(container) {
    container.empty();
    const headerContainer = container.createDiv("sd-calendar-header");
    headerContainer.createEl("h3", { text: "\u{1F4C5} \u6211\u7684\u65E5\u5386", cls: "sd-section-title", attr: { style: "border:none" } });
    ...
    modeToggle.onclick = async () => {
      ...
      if (this.calendarViewMode === "week") {
        this.currentMonth = (0, import_obsidian.moment)();
      }
      await this.renderCalendarArea(container);
    };
    const prevBtn = controls.createEl("button", { text: "\u2190", cls: "sd-btn secondary" });
    const getWeekStart = (m) => m.clone().subtract(m.isoWeekday() - 1, "days").startOf("day");
    const getWeekEnd = (m) => m.clone().add(7 - m.isoWeekday(), "days").endOf("day");
    const displayLabel = this.calendarViewMode === "month" ? this.currentMonth.format("YY\u5E74MM\u6708") : getWeekStart(this.currentMonth).format("MM.DD") + " - " + getWeekEnd(this.currentMonth).format("MM.DD");
    ...
    const todayBtn = controls.createEl("button", { text: "\u{1F4CC} \u6253\u5361", cls: "sd-btn", attr: { style: "padding: 6px 10px; font-size: 0.85em;" } });
    ...
    todayBtn.onclick = () => {
      new LogMoodModal(this.app, this.plugin, (0, import_obsidian.moment)().format("YYYY-MM-DD"), () => this.renderCalendarArea(container)).open();
    };
    ...
    const startDate = this.calendarViewMode === "month" ? getWeekStart(this.currentMonth.clone().startOf("month")) : getWeekStart(this.currentMonth.clone().subtract(2, "weeks"));
    const endDate = this.calendarViewMode === "month" ? getWeekEnd(this.currentMonth.clone().endOf("month")) : getWeekEnd(this.currentMonth.clone().add(2, "weeks"));
    const day = startDate.clone();
    let moodCounts = {};
    while (day.isSameOrBefore(endDate, "day")) {
      const dateStr = day.format("YYYY-MM-DD");
      const isToday = day.isSame((0, import_obsidian.moment)(), "day");
...
\u70B9\u51FB\u67E5\u770B\u8BE6\u60C5`;
  ...
  async renderTodoArea(container) {
    ...
    const renderList = async () => {
      ...
      displayTodos.forEach((t) => {
        ...
        item.addEventListener("dragstart", (e) => {
          var _a;
          (_a = e.dataTransfer) == null ? void 0 : _a.setData("text/plain", t.id);
        ...
        if (t.subtasks && t.subtasks.length > 0) {
          ...
          const subtaskToggle = metaDiv.createSpan({ text: `\u{1F4CB} \u5B50\u4EFB\u52A1 (${completedCount}/${t.subtasks.length})`, cls: "sd-todo-subtask-toggle" });
  ...
  async renderScheduleArea(container) {
    const header = container.createDiv({ attr: { style: "display:flex; justify-content:space-between; align-items:center" } });
    header.createEl("h3", { text: "\u{1F4C5} \u65E5\u7A0B\u7BA1\u7406", cls: "sd-section-title", attr: { style: "margin:0; border:none" } });
    ...
    const renderList = async () => {
      ...
      schedules.forEach((s) => {
        ...
        const isConflict = s.time && schedules.some(
          (other) => other.id !== s.id && other.date === s.date && (other.time === s.time || other.time && s.time && other.endTime && s.time < other.endTime && s.time > other.time)
        );
        if (isConflict) {
        ...
        if (currentTab === "present") {
          ...
          } else if (diffMins <= 0 && eventMoment.isSame((0, import_obsidian.moment)(), "day")) {
  ...
  updateCharts(forceRedraw = false) {
    ...
    const isDark = (_a = document.querySelector(".smart-dashboard-container")) == null ? void 0 : _a.classList.contains("theme-dark");
    ...
    if (this.currentMode === "7days") {
      labels = Array.from({ length: 7 }, (_, i) => (0, import_obsidian.moment)().subtract(6 - i, "days").format("MM-DD"));
      formatFn = (d) => d.format("MM-DD");
    } else if (this.currentMode === "month") {
      const daysInMonth = (0, import_obsidian.moment)().daysInMonth();
      labels = Array.from({ length: daysInMonth }, (_, i) => (0, import_obsidian.moment)().startOf("month").add(i, "days").format("MM-DD"));
      formatFn = (d) => d.format("MM-DD");
    } else {
      labels = Array.from({ length: 12 }, (_, i) => (0, import_obsidian.moment)().startOf("year").add(i, "months").format("YYYY-MM"));
      formatFn = (d) => d.format("YYYY-MM");
    }
    const dataMap = {};
    labels.forEach((l) => dataMap[l] = { Total: 0, \u5B66\u79D1: 0, \u8BFB\u4E66\u7B14\u8BB0: 0, \u8BBA\u6587: 0, \u65E5\u8BB0: 0, \u968F\u7B14: 0, \u5176\u4ED6: 0 });
    let pieTotals = { \u5B66\u79D1: 0, \u8BFB\u4E66\u7B14\u8BB0: 0, \u8BBA\u6587: 0, \u65E5\u8BB0: 0, \u968F\u7B14: 0, \u5176\u4ED6: 0 };
    files.forEach((file) => {
      var _a2, _b;
      const cache = this.app.metadataCache.getFileCache(file);
      let created = ((_a2 = cache == null ? void 0 : cache.frontmatter) == null ? void 0 : _a2.created) ? (0, import_obsidian.moment)(cache.frontmatter.created) : (0, import_obsidian.moment)(file.stat.ctime);
      const key = formatFn(created);
      if (dataMap[key]) {
        dataMap[key].Total++;
        const type = ((_b = cache == null ? void 0 : cache.frontmatter) == null ? void 0 : _b.type) || "\u5176\u4ED6";
        if (dataMap[key][type] !== void 0) {
          dataMap[key][type]++;
          pieTotals[type]++;
        } else {
          dataMap[key]["\u5176\u4ED6"]++;
    ...
    if (lineCanvas) {
      this.lineChart = new auto_default(lineCanvas, {
        type: "line",
        data: {
          labels,
          datasets: [
    ...
    if (pieCanvas) {
      this.pieChart = new auto_default(pieCanvas, {
        type: "doughnut",
        data: {
          labels: Object.keys(pieTotals).filter((k) => pieTotals[k] > 0),
          datasets: [{
            data: Object.values(pieTotals).filter((v) => v > 0),
  ...
  async renderTradingArea(container) {
    ...
    let totalPnL = 0;
    const badHabitsMap = /* @__PURE__ */ new Map();
    records.forEach((r) => {
    ...
    Array.from(badHabitsMap.entries()).sort((a, b) => a[1].loss - b[1].loss).forEach(([bh, data]) => {
    ...
    flowCol.createEl("h4", { text: "\u{1F4DD} \u8FD1\u671F\u6D41\u6C34" });
    ...
    records.forEach((r) => {
      ...
      const timeStr = r.timestamp ? (0, import_obsidian.moment)(r.timestamp).format("MM-DD HH:mm") : "-";
  ...
  async renderUsageBody(body) {
    try {
      ...
      for (const k of Object.keys(days)) {
        ...
        monthAll.cache += dt.cache;
        monthAll.reasoning += dt.reasoning;
      }
  ...
  renderMonthHeatmap(container, days, today, now) {
    try {
  ...
  renderYearHeatmap(container, days, today, now) {
    try {
...
var ViewTradeModal = class extends import_obsidian.Modal {
  constructor(app, plugin, trade, tickers, onEdit) {
    super(app);
    this.plugin = plugin;
    this.trade = trade;
    this.tickers = tickers;
  ...
  onOpen() {
    ...
    contentEl.createEl("p", { text: `\u65E5\u671F: ${this.trade.date || (0, import_obsidian.moment)(this.trade.timestamp).format("YYYY-MM-DD")} | \u64CD\u4F5C: ${this.trade.action} | \u4EF7\u683C: ${this.trade.price} | \u6570\u91CF: ${this.trade.volume}` });
    ...
    contentEl.createEl("h3", { text: "\u{1F916} AI \u6DF1\u5EA6\u590D\u76D8" });
