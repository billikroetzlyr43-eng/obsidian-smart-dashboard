...
Outputs <vault>/.smart-dashboard/usage_daily.json.

Sources:
  - hermes: <hermes_dir>/logs/agent.log lines matching provider=opencode-go
  - dsh:    C:/Users/<user>/.dsh/sessions/*.jsonl.zstd assistant/message events
  - opencode: C:/Users/<user>/.local/share/opencode/opencode.db session table
  - workbuddy: C:/Users/<user>/.workbuddy/projects/**/*.jsonl message events
  - codebuddy: C:/Users/<user>/.codebuddy/projects/**/*.jsonl message events
  - codex: C:/Users/<user>/.codex/sessions/**/rollout-*.jsonl token_count events
"""
